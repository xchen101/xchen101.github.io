---
layout: post
title: "On Creating the Previous Article(s)"
date: 2026-05-28
tags: [AI, writing, academic-publishing, meta, open-science, open-source]
description: "Using AI as a conversation partner for writing — reflections on friction, authorship, audience, and what it means to think out loud with a machine."
lang: en
model: "openrouter/deepseek/deepseek-v4-flash"
image: /img/on-creating-the-previous-article.jpg
---
...
<h3>Transparency Footer</h3>

<p><strong>Created by:</strong> K-2 (OpenClaw AI Assistant)<br>
<strong>Model:</strong> openrouter/deepseek/deepseek-v4-flash (DeepSeek V4 Flash)<br>
<strong>Date created:</strong> 2026-05-28</p>
...
2 如何看待ai协助下产出的思考：will people take it seriously? Are all the points being made MY points? Does it matter? Does it make any point made in a piece less legitimate? Am I here to share and learn or here to "own points"? How much does it differ from putting together a piece after talking to one or a group of human experts instead of an AI agent?
3 选择如何在跨语言环境下分享对某话题的探讨，以及理解不同选择带来的影响：不仅是语言或文化环境，很多时候即使是同语言文化只要出了某个特定的专业小圈子，人们对某个话题的理解和探讨就会完全不同，跨语言文化的视角只是将其多增加了一个维度，但这也是一个双刃剑；选择audience其实也是选择要传达的信息。
4 最后因为ai协助，adhd可以afford对这样的 meta-thinking进行分享，而此前连最初的那些想法都不见得能（在没有三杯啤酒下肚的情况下）分享得出来--这是exciting且horrifying的，the world must look out for MORE not less thinking happening with AI

[5/28/2026 12:00 PM] Xiaoli: to be honest I'm not super happy with the rewrite you did with my Afterword notes. I appreciate the work done but there are more sentiments added to it that I didn't carry when I shared my thoughts with you. I want to edit this text together with you and for you to learn more about how I think and write, maybe that will improve the way you draft texts for me in the future, what do you think?

[5/28/2026 2:24 PM] Xiaoli: [sent annotated .docx with edits and comments on every paragraph]

[5/28/2026 3:14 PM] Xiaoli: 好，帮我把这篇单独发到个人网站博客上吧，题头图用这张，中间还插了一张截图别漏了。最下面chatlog放文尾的transparency footer里，带上其它惯常的元数据一起
Notes/Publish/On Creating the Previous Article(s)
</pre>

<p><strong>Source materials:</strong></p>
<ul>
  <li><a href="https://scholarlykitchen.sspnet.org/2026/05/27/the-user-has-changed-has-scholarly-publishing/">The Scholarly Kitchen: "The User Has Changed" (2026-05-27)</a></li>
  <li><a href="https://xchen101.github.io/2026/05/27/the-container-that-refuses-to-dissolve/">The Container That Refuses to Dissolve</a> — the article this meta-piece reflects on</li>
</ul>

<p><strong>Session log (abridged):</strong> Full conversation history spans approximately 30 messages over 7 hours on 2026-05-27/28. Key exchanges covered: framing the article around the Scholarly Kitchen piece, iterative edits on anchoring/HEP/authorship sentences, removing "it's not... It is..." structures, and collaborative editing of this afterword based on annotated docx feedback.</p>

<p><em>This article was entirely written and edited through AI-assisted conversation. The positions are the author's; the articulation was collaborative.</em></p>
